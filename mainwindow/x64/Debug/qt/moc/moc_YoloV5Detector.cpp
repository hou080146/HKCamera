...
const QMetaObject YoloV5Detector::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_YoloV5Detector.data,
      qt_meta_data_YoloV5Detector,  qt_static_metacall, nullptr, nullptr}
};
...
void *YoloV5Detector::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_YoloV5Detector.stringdata0))
        return static_cast<void*>(const_cast< YoloV5Detector*>(this));
